...
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Broccoli<br>(Parboil it!)          | Base:<br><ul><li>Garlic</li><li>chili powder</li></ul><br>Seasoning:<br><ul><li>Salt</li><li>MSG</li></ul><br>Sauce:<br><ul><li>Soy sauce</li></ul>                                                                                                                    | You could also avoid parboiling by adding small amounts of water to let it steam/boil                                                                                                                                                                                                    |
| Bok choy (青江菜)<br>(Parboil it!) | Base:<br>- Garlic<br>Seasoning:<br>- Salt<br>- MSG<br>- pepper                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                          |
| On choy/water spinach (空心菜)     | Base:<br>- Garlic<br>Seasoning:<br>- Salt<br>- MSG<br>- pepper                                                                                                                                                                                                         | After washing the veggies, snap the long stems into segments including the leaves so it's easier to handle                                                                                                                                                                               |
| Yam leaf (红薯叶)                  | Base:<br>- Garlic<br>Seasoning:<br>- Salt<br>- MSG<br>- pepper                                                                                                                                                                                                         | After washing the veggies, snap the long stems into segments including the leaves so it's easier to handle.                                                                                                                                                                              |
| Garlic chives (韭菜)               | Seasoning:<br>- Salt<br>- MSG<br>- pepper                                                                                                                                                                                                                              | Chop into inch long segments                                                                                                                                                                                                                                                             |
| Bittermelon (苦瓜)                 | Base:<br>- Garlic<br>- Any combination of: zha cai, shrimp, or fermented black bean<br>Seasoning:<br>- Salt<br>- MSG<br>- pepper<br>Sauce:<br>- tiny bit of soy sauce, or nothing                                                                                      | After deseeding, and slicing the bitter melon into thin strips, toss the strips in some salt to draw out moisture and most of the bitter taste.                                                                                                                                          |
| Eggplant                           | Base:<br>- Garlic<br>- Chili powder<br>- (Optionally) crushed sichuan peppercorn<br>- Some of your favorite Chinese sauce (chili paste, chili crisp, 饭扫光 brand stuff)<br>Seasoning:<br>- None, the sauces should cover saltiness and umami<br>Sauce:<br>- Soy sauce | After washing and chopping the eggplant into chunks, microwave it for a few minutes to cook through and allow it to soak up the sauces more. Instead of microwaving, you could also use a lot more oil when stir-frying to let it absorb more flavors. Eggplant is extremely oil hungry. |